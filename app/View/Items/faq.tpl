...
{% block content %}
    ...
    <div class="faq_item">
        ...
        <div class="faq_answer">Sometimes leadership rewards players or members with free items for attending events such as our weekly CS:GO Scrims. Participate in an eligible event to receive a reward. All members also receive a one-time Member Gift Basket.</div>
    </div>

    <div class="faq_item">
        <div class="faq_question">How do I send gifts to other players?</div>
        <div class="faq_answer">Click on a player's name on the store and then click the "send gift" button on that person's store profile. If the player is in the same server as you, you can type <code>!gift PLAYER</code> as a shortcut. You can also {{ html.link('search', {'controller': 'SteamPlayerCache', 'action': 'search'}) }} for players in our database.</div>
    </div>

    <div class="faq_item">
        <div class="faq_question">Where do I give feedback and suggest new items?</div>
        <div class="faq_answer">Submit your feedback on our forums at <a href="http://reflex-gamers.com">reflex-gamers.com</a>. You may also review an item on its respective listing page after purchasing it, but suggestions on how to improve items are best heard on our forums.</div>
    </div>
